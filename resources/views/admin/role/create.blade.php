...
@section('title', __('role.title.create'))
...
@section('content')
	...
	<div class="d-none">
		<ol class="breadcrumb" id="breadcrumb">
			...
			<li class="breadcrumb-item active" aria-current="page">{{ __('role.title.create') }}</li>
		</ol>
	</div>
		...
		<div class="card-body">
			<form method="post" action="{{ route('admin.role.store') }}" enctype="multipart/form-data">
				...
				<div class="form-group row">
					...
					<div class="col-lg-10 col-md-9">
                        <div class="form-check">
                            <input class="form-check-input" type="radio" name="has_access" value="1" id="has_access-1" {{ old('has_access') == '1' ? 'checked' : '' }}>
                            <label class="form-check-label" for="has_access-1">
                            {{ __('form.yes') }}
                            </label>
                        </div>
                        <div class="form-check">
                            <input class="form-check-input" type="radio" name="has_access" value="0" id="has_access-0" {{ old('has_access') == '0' ? 'checked' : '' }}>
				...
				<div class="form-group row">
					...
					<div class="col-lg-10 col-md-9">
                        <div class="form-check">
                            <input class="form-check-input" type="radio" name="has_position" value="1" id="has_position-1">
                            <label class="form-check-label" for="has_position-1">
                            {{ __('form.yes') }}
                            </label>
                        </div>
                        <div class="form-check">
                            <input class="form-check-input" type="radio" name="has_position" value="0" id="has_position-0">

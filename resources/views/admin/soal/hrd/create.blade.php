...
@section('content')
  ...
  <!-- Page Heading -->
  <h1 class="h3 mb-2 text-gray-800">Tambah Soal {{ $tes->nama_tes }}</h1>
  <p class="mb-4">Soal tes {{ $tes->nama_tes }} yang digunakan untuk mengetes calon karyawan.</p>

  <!-- DataTales Example -->
  <div class="card shadow mb-4">
    <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
      <h6 class="m-0 font-weight-bold text-primary">Tambah Soal {{ $tes->nama_tes }}</h6>
    </div>
    <div class="card-body">
      <form method="post" action="/hrd/tes/tipe/{{ $id_tes }}/soal/store">
        {{ csrf_field() }}
        <div class="form-row">
          <div class="form-group col-auto">
            ...
            <select name="nomor" class="form-control custom-select {{ $errors->has('nomor') ? 'is-invalid' : '' }}">
              ...
              <option value="{{ $no }}" {{ old('nomor') == $no ? 'selected' : '' }}>{{ $no }}</option>
              @endforeach
            </select>
            @if($errors->has('nomor'))
          ...
          <div class="col-md-6">
            <div class="form-row">
              <div class="form-group col-12 col-sm">
                ...
                <input type="text" name="pilihan[A]" class="form-control pilihan {{ $errors->has('pilihan.A') ? 'is-invalid' : '' }}" placeholder="Masukkan Pilihan A" value="{{ old('pilihan.A') }}">
              ...
              <div class="form-group col-12 col-sm-auto">
                ...
                <select name="disc[A]" class="form-control custom-select disc {{ $errors->has('disc.A') ? 'is-invalid' : '' }}" data-id="disc-a">
                  ...
                  <option value="D" {{ old('disc.A') == 'D' ? 'selected' : '' }}>D</option>
                  <option value="I" {{ old('disc.A') == 'I' ? 'selected' : '' }}>I</option>
                  <option value="S" {{ old('disc.A') == 'S' ? 'selected' : '' }}>S</option>
                  <option value="C" {{ old('disc.A') == 'C' ? 'selected' : '' }}>C</option>
                </select>
          ...
          <div class="col-md-6">
            <div class="form-row">
              <div class="form-group col-12 col-sm">
                ...
                <input type="text" name="pilihan[B]" class="form-control pilihan {{ $errors->has('pilihan.B') ? 'is-invalid' : '' }}" placeholder="Masukkan Pilihan B" value="{{ old('pilihan.B') }}">
              ...
              <div class="form-group col-12 col-sm-auto">
                ...
                <select name="disc[B]" class="form-control custom-select disc {{ $errors->has('disc.B') ? 'is-invalid' : '' }}" data-id="disc-b">
                  <option value="">--Pilih--</option>
                  <option value="D" {{ old('disc.B') == 'D' ? 'selected' : '' }}>D</option>
                  <option value="I" {{ old('disc.B') == 'I' ? 'selected' : '' }}>I</option>
                  <option value="S" {{ old('disc.B') == 'S' ? 'selected' : '' }}>S</option>
                  <option value="C" {{ old('disc.B') == 'C' ? 'selected' : '' }}>C</option>
                </select>
          ...
          <div class="col-md-6">
            <div class="form-row">
              <div class="form-group col-12 col-sm">
                ...
                <input type="text" name="pilihan[C]" class="form-control pilihan {{ $errors->has('pilihan.C') ? 'is-invalid' : '' }}" placeholder="Masukkan Pilihan C" value="{{ old('pilihan.C') }}">
              ...
              <div class="form-group col-12 col-sm-auto">
                ...
                <select name="disc[C]" class="form-control custom-select disc {{ $errors->has('disc.C') ? 'is-invalid' : '' }}" data-id="disc-c">
                  <option value="">--Pilih--</option>
                  <option value="D" {{ old('disc.C') == 'D' ? 'selected' : '' }}>D</option>
                  <option value="I" {{ old('disc.C') == 'I' ? 'selected' : '' }}>I</option>
                  <option value="S" {{ old('disc.C') == 'S' ? 'selected' : '' }}>S</option>
                  <option value="C" {{ old('disc.C') == 'C' ? 'selected' : '' }}>C</option>
                </select>
          ...
          <div class="col-md-6">
            <div class="form-row">
              <div class="form-group col-12 col-sm">
                ...
                <input type="text" name="pilihan[D]" class="form-control pilihan {{ $errors->has('pilihan.D') ? 'is-invalid' : '' }}" placeholder="Masukkan Pilihan D" value="{{ old('pilihan.D') }}">
              ...
              <div class="form-group col-12 col-sm-auto">
                ...
                <select name="disc[D]" class="form-control custom-select disc {{ $errors->has('disc.D') ? 'is-invalid' : '' }}" data-id="disc-d">
                  <option value="">--Pilih--</option>
                  <option value="D" {{ old('disc.D') == 'D' ? 'selected' : '' }}>D</option>
                  <option value="I" {{ old('disc.D') == 'I' ? 'selected' : '' }}>I</option>
                  <option value="S" {{ old('disc.D') == 'S' ? 'selected' : '' }}>S</option>
                  <option value="C" {{ old('disc.D') == 'C' ? 'selected' : '' }}>C</option>
                </select>
        ...
        <div class="form-group">
          ...
          <a href="/hrd/tes/tipe/{{ $id_tes }}/paket/soal/{{ $id_paket }}" class="btn btn-secondary">Kembali</a>
        </div>
      </form>
    </div>
  </div>

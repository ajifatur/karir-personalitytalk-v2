...
@section('title', __('test.title.edit'))
...
@section('content')
	...
	<div class="d-none">
		<ol class="breadcrumb" id="breadcrumb">
			...
			<li class="breadcrumb-item active" aria-current="page">{{ __('test.title.edit') }}</li>
		</ol>
	</div>
			...
			<form method="post" action="{{ route('admin.test.update') }}" enctype="multipart/form-data">
				...
				<div class="form-group row">
					...
					<div class="col-lg-10 col-md-9">
						<input name="name" type="text" class="form-control {{ $errors->has('name') ? 'is-invalid' : '' }}" value="{{ $test->name }}">
						@if($errors->has('name'))
				...
				<div class="form-group row">
					...
					<div class="col-lg-10 col-md-9">
						<input name="code" type="text" class="form-control {{ $errors->has('code') ? 'is-invalid' : '' }}" value="{{ $test->code }}">
						@if($errors->has('code'))

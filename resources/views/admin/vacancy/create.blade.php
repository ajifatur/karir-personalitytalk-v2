		...
		<div class="card-body">
			<form method="post" action="{{ route('admin.vacancy.store') }}" enctype="multipart/form-data">
				...
				<div class="form-group row">
					...
					<div class="col-lg-10 col-md-9">
						<div class="input-group">
							<input name="start_date" type="text" class="form-control {{ $errors->has('start_date') ? 'is-invalid' : '' }}" value="{{ old('start_date') }}" placeholder="dd/mm/yyyy">
				...
				<div class="form-group row">
					...
					<div class="col-lg-10 col-md-9">
						<div class="input-group">
							<input name="end_date" type="text" class="form-control {{ $errors->has('end_date') ? 'is-invalid' : '' }}" value="{{ old('end_date') }}" placeholder="dd/mm/yyyy">
							<div class="input-group-append">

          ...
          <form id="form" method="post" action="/lowongan/{{ $url_form }}/daftar/step-3" enctype="multipart/form-data">
            ...
            <div class="form-row">
              <div class="form-group col-sm-12">
                ...
                <button class="btn btn-sm btn-block rounded {{ $errors->has('file_foto_ijazah') ? 'btn-outline-danger' : 'btn-outline-primary' }} btn-upload" data-id="foto_ijazah" type="button"><i class="fa fa-upload"></i> Upload Foto Ijazah</button>
            ...
            <div class="form-group mt-3">
              <div class="row">
                <div class="col-auto ml-auto">
                  ...
                  <a href="/lowongan/{{ $url_form }}/daftar/step-2" class="btn btn-sm btn-danger rounded">&laquo; Sebelumnya</a>
